...
describe('#parseUrl.js', () => {
    it('should return url if valid url', () => {
        let res1 = parseUrl('http://google.com');
        let res2 = parseUrl('https://repl.it/languages/javascript');
    ...
    it('should return "Invalid URL" if url is invalid', () => {
        let res1 = parseUrl('blabal');
        let res2 = parseUrl('htttp://something.com');
        let res3 = parseUrl('www.magic.edu');
